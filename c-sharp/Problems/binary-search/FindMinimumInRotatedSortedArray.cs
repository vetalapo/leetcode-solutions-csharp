 ...
 *
 * Hint 1:
 *   Array was originally in ascending order.
 *   Now that the array is rotated,
 *   there would be a point in the array where
 *   there is a small deflection from the increasing sequence.eg.
