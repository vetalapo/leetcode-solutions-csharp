 ...
 **
 * There are n mountains in a row,
 * and each mountain has a height.
 * You are given an integer array height
 * where height[i] represents the height of mountain i,
 * and an integer threshold.
 *
 * A mountain is called stable
 * if the mountain just before it (if it exists)
